...
export default [
	...
	{length: 1, actions: ['curvefromfile'], preview: null, refresh: false, force: 'auto', medias: 'standard'},
	{length: 2, actions: ['curvefromfile', 'screen'], preview: 1, refresh: false, force: 'auto', medias: 'standard'},
	...
	{length: 2, actions: ['beauty', 'grayscale'], preview: null, refresh: false, force: 'js', medias: 'standard'},
	{length: 2, actions: ['beauty', 'curvefromfile'], preview: null, refresh: false, force: 'js', medias: 'standard'}
