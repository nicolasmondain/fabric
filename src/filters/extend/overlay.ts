...
export const overlay = (fabric: library) => {
  fabric.Image.filters.overlay = fabric.util.createClass(fabric.Image.filters.BaseFilter, {
    type: 'overlay',
    vertexSource: `
  ...
  fabric.Image.filters.overlay.fromObject = fabric.Image.filters.BaseFilter.fromObject;
};
