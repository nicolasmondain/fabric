...
export const replace = (fabric: library) => {

	fabric.Image.filters.replace = fabric.util.createClass(fabric.Image.filters.BaseFilter, {
	...
	fabric.Image.filters.replace.fromObject = fabric.Image.filters.BaseFilter.fromObject;
