...
export const darken = (fabric: library) => {
  fabric.Image.filters.darken = fabric.util.createClass(fabric.Image.filters.BaseFilter, {
    type: 'darken',
    vertexSource: `
  ...
  fabric.Image.filters.darken.fromObject = fabric.Image.filters.BaseFilter.fromObject;
};
