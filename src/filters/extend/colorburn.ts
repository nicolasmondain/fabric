			...
			if(n === m){
				...
				for(let i = 0; i < n; i += 4){
					...
					if(methods.applytothecurrenti(i, this.homothetic.x, this.homothetic.y, this.homothetic.w, this.homothetic.h, options.sourceWidth)){
						...
						data[i]     = data2[i] === 0 ? data2[i] : Math.max(0, 255 - (((255 - data[i]) * 255) / data2[i]));
						data[i + 1] = data2[i + 1] === 0 ? data2[i + 1] : Math.max(0, 255 - (((255 - data[i + 1]) * 255) / data2[i + 1]));
						data[i + 2] = data2[i + 2] === 0 ? data2[i + 2] : Math.max(0, 255 - (((255 - data[i + 2]) * 255) / data2[i + 2]));
