...
export const difference = (fabric: library) => {

	fabric.Image.filters.difference = fabric.util.createClass(fabric.Image.filters.BaseFilter, {
		...
		fragmentSource: `
			...
			void main(){
				...
				color.r = abs(color.r - color2.r + 0.0);
				color.g = abs(color.g - color2.g + 0.0);
				color.b = abs(color.b - color2.b + 0.0);
	...
	fabric.Image.filters.difference.fromObject = fabric.Image.filters.BaseFilter.fromObject;
