      ...
      if (n === m) {
        for (let i = 0; i < n; i += 4) {
          if (
            ...
            data[i] =
              data2[i] < 128
                ? methods.onecolorburn(data[i], 2 * data2[i])
                : methods.onecolordodge(data[i], 2 * (data2[i] - 128));
            data[i + 1] =
              data2[i + 1] < 128
                ? methods.onecolorburn(data[i + 1], 2 * data2[i + 1])
                : methods.onecolordodge(data[i + 1], 2 * (data2[i + 1] - 128));
            data[i + 2] =
              data2[i + 2] < 128
                ? methods.onecolorburn(data[i + 2], 2 * data2[i + 2])
                : methods.onecolordodge(data[i + 2], 2 * (data2[i + 2] - 128));
          }
        }
      }
    },
